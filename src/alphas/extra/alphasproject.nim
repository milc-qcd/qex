...
proc projectU*(self: UnitaryProjection, v: var Mat1; u: Mat2, regulate: bool = false) =
  ...
  v := u
  self.projectU(v, regulate)

template projectU*(
    self: UnitaryProjection, 
    r: var Color,
    regulate: bool = false
  ) = self.projectU(r[], regulate)

template projectU*(
    self: UnitaryProjection, 
    r: var Color, x: Color2,
    regulate: bool = false
  ) = self.projectU(r[], x[], regulate)
...
proc projectUderiv*(
  ...
  self.projectU(u, x, regulate)
  self.projectUderiv(v, u, x, chain, regulate)
...
template projectUderiv*(
    ...
    chain: Color4,
    regulate: bool = false
  ) = self.projectUderiv(r[], u[], x[], chain[], regulate)
...
template projectUderiv*(
    ...
    chain: Color4,
    regulate: bool = false
  ) = self.projectUderiv(r[], x[], chain[], regulate)
